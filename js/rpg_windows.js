    ...
    if (this._textState.text.trim() !== "") {
        ...
        if (mayNeedAdjustment != 0) {
            if (!text.startsWith("\x1b.") && !text.startsWith("\x1b>")) { // If pause or instant-type is not already identifiable at start, remove all other escape codes to determine whether there is or isn't one
                ...
                text = text.replace(/\x1bco\[(\d+)\]/gi, "");
                text = text.replace(/\x1bpx\[(\d+)\]/gi, "");
                text = text.replace(/\x1bpy\[(\d+)\]/gi, "");
                text = text.replace(/\x1btx\[(\d+)\]/gi, "");
                text = text.replace(/\x1bty\[(\d+)\]/gi, "");
                text = text.replace(/\x1bop\[(\d+)\]/gi, "");
                text = text.replace(/\x1boc\[(\d+)\]/gi, "");
                text = text.replace(/\x1bow\[(\d+)\]/gi, "");
                text = text.replace(/\x1brc\[(\d+)\]/gi, "");
                text = text.replace(/\x1brs\[(\d+)\]/gi, "");
                text = text.replace(/\x1brw\[(\d+)\]/gi, "");
                text = text.replace(/\x1bdf\[(\d+)\]/gi, "");
                text = text.replace(/\x1bsv\[(\d+)\]/gi, "");
                text = text.replace(/\x1bld\[(\d+)\]/gi, "");
            }
